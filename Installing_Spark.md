# Установка Apache Spark на ALT Linux
...
Убедитесь, что файл Spark например (`spark-4.0.1-bin-hadoop3.tgz`) был загружен в директорию `/home/executor/Загрузки` или измените на вашу директорию.
